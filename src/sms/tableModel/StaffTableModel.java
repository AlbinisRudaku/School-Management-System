...
public class StaffTableModel {
    ...
    public StaffTableModel(int empNo, String teacherName, String dob, String gender, String email, String assumpOfDuties, String phone, String address, String prsntGrade) {
        this.empNo = empNo;
